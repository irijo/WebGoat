...
public class Servers {
    ...
    public List<Server> sort(@RequestParam String column) throws Exception {
        ...
        try (
            ...
            String queryTest = "select id, hostname, ip, mac, status, description from servers  where status <> \'out of order\' order by COLUMN=?";
            statement.setString(1, column)
            PreparedStatement preparedStatement = connection.prepareStatement(queryTest) {
